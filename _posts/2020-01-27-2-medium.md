...
Of these eight combinations, in only six (1, 2, 3, 4, 5, 6) is the other side _of the first card_ black. Therefore the probability that the side of the first card facing down is black, given that the side of the first card facing up is black, is $\frac68 = \frac34$.